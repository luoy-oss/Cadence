...
class AppColors {
  ...
  // 命中等级颜色
  static const hitPerfect = Color(0xFFFFD700);    // 金色
  static const hitGreat = Color(0xFF22C55E);       // 绿色
  static const hitGood = Color(0xFF3B82F6);        // 蓝色
  static const hitMiss = Color(0xFFEF4444);        // 红色

  // 游戏覆盖层颜色
  static const overlayBg = Color(0x00000000);      // 全透明
  static const noteApproach = Color(0xCCFFFFFF);   // 接近圆
  static const noteTarget = Color(0xFFFFFFFF);     // 目标圆
  ...
  static Color forGrade(String grade) {
    switch (grade) {
      case 'S': return hitPerfect;
      case 'A': return hitGreat;
      case 'B': return hitGood;
      case 'C': return hitGood;
      default: return hitMiss;
    }
  }
}
